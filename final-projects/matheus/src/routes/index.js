...
routes.get('/soldiers/:id', verifyToken, GetSoldier.GetOneSoldier)
...
routes.get('/battle-register/:id', verifyToken, BattleRegister.RegisterById)
...
routes.get('/siege-weapons/:id', verifyToken, GetSiegeWeapon.GetOneSiegeWeapon)
...
routes.get('/equipaments/:id', verifyToken, GetEquipaments.GetOneEquipaments)
